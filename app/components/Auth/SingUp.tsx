...
const SingUp = () => {
  return (
    <div className='overflow-hidden h-[84vh] flex flex-col items-center justify-center '>
       ...
       {/* singup button */}
       <button onClick={() => {signIn('google', {callbackUrl:"/"})}}className="px-12 py-3 mt-[2rem] bg-purple-700 hover:bg-purple-900 transition-all duration-300 rounded-lg text-white">
        Sing Up Now
       </button>
